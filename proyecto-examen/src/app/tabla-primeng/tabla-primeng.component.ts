...
@Component({
  selector: 'app-tabla-primeng',
  templateUrl: './tabla-primeng.component.html',
  styleUrls: ['./tabla-primeng.component.css']
})
export class TablaPrimengComponent implements OnInit {

   @Input() datosTablaDetalle: Medicamento[] = [];
